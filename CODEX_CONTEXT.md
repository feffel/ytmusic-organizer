...
- CLI parse/usage errors now print scoped help with exit code `2`: top-level parse failures show top-level help, while subcommand parse failures (for example `ytmo setup -q`) show that subcommand’s help.
